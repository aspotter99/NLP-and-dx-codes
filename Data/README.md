This folder houes all data used in this project.  The instructions for creating the database can be found in the src folder.  .csv files that are generated in the notebooks are also housed here.
